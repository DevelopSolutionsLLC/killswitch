...
- `up` stops the protected `SERVICE`, verifies it is down, waits for VPN readiness, configures UFW, verifies readiness again under the firewall rules, then starts the protected service.
